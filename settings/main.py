...
JOURNEY_ENDURANCE_WEBHOOK_URL = env.str('JOURNEY_ENDURANCE_WEBHOOK_URL', '')
JOURNEY_ENDURANCE_WEBHOOK_SECRET = env.str('JOURNEY_ENDURANCE_WEBHOOK_SECRET', '')
JOURNEY_ENDURANCE_APP_URL = env.str('JOURNEY_ENDURANCE_APP_URL', 'https://app.coachwatts.com')
